...
@section('doc-title', 'CERTIFICATE TO FILE ACTION (CFA) SUMMARY REPORT')
@section('doc-type', 'cfa-cases')
...
@section('content')
<div class="report-title">CERTIFICATE TO FILE ACTION (CFA) REPORT</div>
...
<p style="margin-bottom: 10px; font-weight: bold;">The following cases have been issued a Certificate to File Action and elevated to court:</p>

<table class="data-table">
    <thead>
        <tr>
            <th style="width: 15%;">CASE NO.</th>
            <th style="width: 30%;">COMPLAINANTS</th>
            <th style="width: 30%;">RESPONDENTS</th>
            <th style="width: 25%;">NATURE OF CASE</th>
        </tr>
    </thead>
    <tbody>
        ...
        <tr>
            ...
            <td>{{ strtoupper($case_item->nature_of_case) }}</td>
        </tr>
        @empty
        <tr>
            <td colspan="4" class="text-center">No CFA cases recorded for this period.</td>
        </tr>
        @endforelse
    </tbody>
</table>
...
<ul style="list-style: none; padding-left: 0;">
    <li><span class="font-bold">Total CFA Cases Issued: {{ ($cases ?? collect())->count() }}</span></li>
</ul>
